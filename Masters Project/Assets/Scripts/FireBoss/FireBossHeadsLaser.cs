...
/// <summary>
/// This is used to create the laser that shoot from the MOUTH of the heads attached to FireBoss
/// VERY similar to the laser script used by Enemy2
/// </summary>

public class FireBossHeadsLaser : MonoBehaviour
{
    ...
    //RaycastHit hit;                     //i dont think i need this?
    ...
    void Start()
    {
        ...
        lineRenderer.endWidth = laserWidth;             //set laser width
    ...
    IEnumerator ShootLaser()
    {
        ...
        if (animate.GetBool("BossHeadAttack1") == true)
        {
